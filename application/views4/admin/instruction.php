            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Table of Instruction</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?=$n;?></td>
                        <td><?=substr(strip_tags($contact->ins_description),0,200).".......";?></td>
                     <?php
						echo '<td>';
							  echo anchor("admin_controller/show_edit_instruction/".$contact->ins_id,'<i class="glyphicon glyphicon-edit"></i>','title="Edit"').nbs(2);
                     ?>
