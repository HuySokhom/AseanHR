...
<div class="container">
        ...
        <div class="left-company-profile-content">
            ...
            <form action="<?php echo site_url('Companys/edit_job/'.$edeit->job_id); ?>" method="post" enctype="multipart/form-data">
            	<div class="group-post-job">
                    <div class="job-post-create">
                        <label><span style="margin-right:40px;">Job Title</span></label>
                        <input type="text" value="<?=$edeit->job_name;?>" name="job_name"/>
                    </div>
                    <div class="job-post-create">
                ...
                <div class="group-post-job">
                 ...
                 <input name="job_expire_day"  value="<?=$edeit->job_expire_day;?>" type="text" class="form-control"  />
                 <input name="job_period"  value="0" type="text" class="form-control"  />
                ...
                <div class="submit-job-post">
                    <input type="submit" name="add" class="create-job-post" value="Update Job"/>
                </div>
            </form>
      	</div>
