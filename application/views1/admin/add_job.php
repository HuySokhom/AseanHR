                        ...
                        <div class="col-lg-12">
                              ...
                              <input type="hidden"  class="form-control" value="JOB-<?=$row->job_id + 1;?>" name="job_reference" required />
                               ...
                               <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="job_hire" type="text" class="form-control"  required />
                                </div>
                                <div class="form-group">
                                    <label>Sex</label>
                                ...
                                <div class="form-group">
                                    <label>Age </label>
                                    <input name="job_age" type="text" class="form-control"  required />
                                </div>
                                <div class="form-group">
                                    <label>Qualification</label>
                                    <input name="job_qualification" type="text" class="form-control"  required />
                                </div>
                                 <div class="form-group">
                                    <label>Language</label>
                                    <input name="job_language" type="text" class="form-control"  required />
                                </div>
                            ...
                            <div class="col-lg-6">
                              	<div class="form-group">
                                    ...
                                    <input name="job_experience" type="text" class="form-control"  required />
                                </div>
                                <div class="form-group">
                                    <label>Company:</label>
