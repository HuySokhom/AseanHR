...
<div class="col-md-12 box-1">
    ...
    <div class="box box-warning">
		...
		?>
				<?php echo form_open("admin_controller/edit_job/".$edeit->job_id);?>
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input name="job_name" value="<?=$edeit->job_name;?>" type="text" class="form-control"  required />
                                </div>
                                <div class="form-group">
                                    <label>Number Of Hire</label>
                                    <input name="job_hire" value="<?=$edeit->job_hire;?>" type="text" class="form-control"  required />
                                </div>
                                <div class="form-group">
                                    <label>Sex</label>
                                ...
                                <div class="form-group">
                                    <label>Age </label>
                                    <input name="job_age" value="<?=$edeit->job_age;?>" type="text" class="form-control"  required />
                                </div>
                                <div class="form-group">
                                    <label>Qualification</label>
                                    <input name="job_qualification" value="<?=$edeit->job_qualification;?>" type="text" class="form-control"  required />
                                </div>
                                 <div class="form-group">
                                    <label>Language</label>
                                    <input name="job_language" value="<?=$edeit->job_language;?>" type="text" class="form-control"  required />
                                </div>
                         ...
                         <?php /*?>       <div class="form-group">
                                ...
                                <input name="job_expire_day"  value="<?=$edeit->job_expire_day;?>" type="hidden" class="form-control"  />
                                <input name="job_expire_date"  value="<?=$edeit->job_expire_date;?>" type="hidden" class="form-control"  />
                            ...
                            <div class="col-lg-6">
                            	<div class="form-group">
                                    ...
                                    <input name="job_experience"  value="<?=$edeit->job_experience;?>" type="text" class="form-control"  required />
                                </div>
                                <div class="form-group">
                                <label>Company</label>
                                     <select name="comp_id" required class="form-control">
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                            <input type="submit" value="Update Job" name="add" class="btn btn-primary" />
                             </div>
                        </div>
                    </div> <!--end row-->
