...
<div class="col-md-12 box-1">
    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
				<?php echo form_open("admin_controller/insert_maincategory");?>
					<!-- text input -->
					<div class="form-group">
						<label>Main Category Name:</label>
						<input value="" name="name" type="text" class="form-control form-req" placeholder="Enter Page Name..." required>
					</div>
                    <!-- text input -->
					<!--<div class="form-group">
