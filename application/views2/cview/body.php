   ...
   $(document).ready(function(e) {
    ...
    <div class="container">
        ...
        <div class="left-content">
                      ...
                      <ul>
                         ...
                         <?php 
								...
								?>
                                     ...
                                     <li>   <a href="<?php echo site_url('Pages/job_by_function/'.$fun->fun_id)?>"><?php echo $fun->fun_name; ?>

                                        (<?php  $total = 0; 

										 foreach($show_job_all as $all){

											if($all->job_role == 0){

											if($fun->fun_id == $all->func_id){ 

													$total += count($all->job_id);
                            ...
                            <?php 
								...
								?>
                                	...
                                	<li>
                                        ...
                                        <a href="<?php echo site_url('Pages/job_by_industry/'.$ind->ind_id)?>"><?php echo $ind->ind_name; ?> 
                        ...
                        <?php 
								...
								?>
                                	...
                                	<li>
                                        ...
                                        <a href="<?php echo site_url('Pages/job_by_location/'.$loc->loc_id)?>"><?php echo $loc->loc_name; ?>
                        	...
                        	<?php 
								...
								?>
                                	...
                                	<li>
                                        ...
                                        <a href="<?php echo site_url('Pages/job_by_salary/'.$sal->sal_id)?>"><?php echo $sal->sal_name; ?> 
           ...
           <?php /*?> <div class="block-job-vation">

                <div class="job-vacation">

                	<img src="<?php echo base_url();?>library/img/vacaction.jpg"/>

                </div>

                <div class="orgation-type">

                	<div class="in-orgation-type-left">
                        ...
                        <div class="column">
                        	...
                        	<div class="in-column-sub">

                        		<a href="<?php echo site_url('Pages/job_by_organization/'.$type->typ_id)?>"><?php $cnt =$type->typ_name; echo substr($cnt,0,25); ?>
                    ...
                    <div class="in-orgation-type-right">
                        ...
                        <div class="schedule-div"><a href="<?php echo site_url('Pages/job_by_term/'.$term->ter_id)?>"><?php echo $term->ter_name; ?>
            ...
            <div class="list-table-job">
					...
					<table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <!-------content---------->
                                  <?php
                                      foreach($show_job_limit_urgent as $ecv){
                                 ...
                                 <!--end urgent-->
                                 <?php
                                      foreach($show_job_limit_new as $ecv){	
