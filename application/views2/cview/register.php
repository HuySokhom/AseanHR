...
<div class="container">
      <div id="wrapper">
      	  ...
      	  <input type="checkbox" id="employer" name="check" value="employer"/><span style="font-size:16px; color:red;"> If you want to register as employer, pleack select check box.</span>
          </div>
          <div class="join">Join Today</div>
          <div class="lock"></div>
          <div class="clr"></div>
          <div class="login-options">Choose facebook on of the following sign up methods.</div>
          ...
          <div class="re_message">
              ...
              <form class="forms" action="<?php echo site_url('login_controller/act_register'); ?>" method="post" name="register">
                  <input name="name" type="text" placeholder="Enter your full name..." size="70" onClick="border: 1px solid #30a8da;" id="username"/>
                  <select name="sex">
                      <option value="0">Male</option>
                      <option value="1">Female</option>
                      <option value="2">Unlimited</option>
                  </select>
                  <input name="email" type="email" placeholder="Enter your email address..." size="70" onClick="border: 1px solid #30a8da;" id="mail"/>
                  <input name="password" type="password" placeholder="Enter your password..." size="70" onClick="border: 1px solid #30a8da;" id="passwords"/>
                  <input name="phone" type="text" placeholder="Enter your phone number..." size="70" onClick="border: 1px solid #30a8da;" id="phone"/>
                  <textarea onblur="this.placeholder = 'Address'" onfocus="this.placeholder = ''" name="address" rows="5" placeholder="Address" required=""></textarea>
                  <input type="submit" value="Create My Account" class="create-acc"/>
              </form>
           </div>
...
<script>
	$(document).ready(function() {
		...
		<div id="contain">
            ...
            <input type="checkbox" id="employee" name="check" value="employee"/><span style="font-size:16px; color:red;"> If you want to register as employee, please select check box.</span>
            	<form role="form" method="post" action="<?=site_url("login_controller/act_register_employer");?>" enctype="multipart/form-data">
                    ...
                    <div class="group-post-job">
                        <div class="job-post">
                            ...
                            <input name="com_fax" type="text" required />
                        </div>
                        <div class="job-post">
                            <label>Email</label>
                    ...
                    <div class="group-post-job">
                        <div class="job-post">
                            ...
                            <input name="com_website" type="text" required />
                        </div>
                        <div class="job-post">
                            <label>Address</label>
